...
$diag = [
  ...
  'env' => [
    'OPENAI_API_KEY_set' => getenv('OPENAI_API_KEY') ? true : false,
    'AI_ENABLED' => getenv('AI_ENABLED') ?: null,
  ],
  'paths' => [
    '__DIR__' => __DIR__,
...
// Simple OpenAI reachability test (only checks env presence)
$diag['openai_ready'] = $diag['extensions']['curl'] && !empty(getenv('OPENAI_API_KEY'));
